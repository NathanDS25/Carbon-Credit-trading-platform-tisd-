...
import { TrendingUp, Activity, Wallet, ShieldCheck, Zap } from 'lucide-react';
    ...
    <DashboardLayout role="COMPANY">
      <div className="grid grid-cols-1 xl:grid-cols-4 gap-6 h-full pb-8">
        ...
        <div className="xl:col-span-3 space-y-6 flex flex-col">
          ...
          {/* Candlestick Chart */}
          <div className="flex-1 glass rounded-3xl border border-white/5 p-8 min-h-[500px] relative overflow-hidden">
            <div className="absolute top-8 left-8 z-10">
                <h3 className="text-sm font-black uppercase tracking-widest flex items-center gap-2">
                    <Activity size={16} className="text-primary" /> Candlestick Terminal
                </h3>
            </div>
